...
<nav class="navbar navbar-default" role="navigation">
  <div class="container">
    <div class="row">
      <div class="col-xs-12"> 
        <a href="/"><img src="images/logo.png" alt="Image" class="logo" style="height: 160px;"></a>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-3 wow fadeIn" data-wow-delay="0.10s"> <span class="numbers">2</span>
          <h5 class="steps">Practical Strategy</h5>
          <p>To get quick & early wins</p>
        </div>
        <!-- end col-3 -->
        <div class="col-md-3 wow fadeIn" data-wow-delay="0.15s"> <span class="numbers">3</span>
          <h5 class="steps">Full Rollout</h5>
          <p>Focusing on time & tactical</p>
        </div>
        <!-- end col-3 -->
  ...
  <section class="wave-things">
    <div class="container">
      <div class="row">
        <div class="col-xs-12">
          <div class="title-box">
            <h2 class="wow fadeInUp" data-wow-delay="0.05s">.let's grow</h2>
            <h5 class="wow fadeInUp" data-wow-delay="0.10s">Our capabilities encompass everything in the Digital marketing space.</h5>
            <span class="shape wow fadeInUp" data-wow-delay="0.15s">O</span> </div>
          <!-- end title-box --> 
        </div>
        <!-- end col-12 -->
        <div class="col-md-4 wow fadeInUp" data-wow-delay="0.05s">
          <h4>SOCIAL MEDIA</h4>
          <p>If you are not on Social media you don’t exist. We Harness the power of social media with creative campaigns and engaging contents.</p>
        </div>
        <!-- end col-4 -->
        <div class="col-md-4 wow fadeInUp" data-wow-delay="0.10s">
          <h4>WEB DESIGN</h4>
          <p>Your website is your company’s first impression to the world digitally. We firmly believe that it is the most important marketing and sales platform that you have.</p>
        </div>
        <!-- end col-4 -->
        <div class="col-md-4 wow fadeInUp" data-wow-delay="0.15s">
          <h4>DIGITAL BRANDING</h4>
          <p>“People don’t buy products, they buy brands,” is an old business saying that gets to the heart of what branding is all about. We will drive your brand on a scientific method & an out of the box concepts.</p>
        </div>
        <!-- end col-4 --> 
      </div>
      <!-- end row -->
